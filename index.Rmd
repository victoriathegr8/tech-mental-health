...
```{r message = FALSE, results = 'asis'}
kable(table_of_data, col.names = c("Age", "State", "Self-Employed", "Tech Company", "Family History of Mental Illness", "Previous Treatment for Mental Illness", "Mental Illness Effects Work", "Company Employee Total", "Majority of Work Remote", "Mental Health Benefits Provided", "Aware of Mental Health Care Provided", "Easy to Take Leave", "Comfortable Discussing MH With Coworkers", "Comfortable Discussing MH with Supervisors"))
```
