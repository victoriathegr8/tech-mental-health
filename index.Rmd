...
This simple bar graph visualizes the company size of those responding to this survey. The graph shows that the respondents work at a broad range of company sizes. We can see that largest group of respondents is for that of large companies, with over a thousand employees. Unfortunately, there is a relatively small pool of respondents for companies with a total of 500-1000 employees, with only 60 respondents for this group.
